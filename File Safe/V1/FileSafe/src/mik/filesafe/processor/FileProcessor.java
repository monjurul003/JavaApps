...
public class FileProcessor {
    ...
    private final String myDocumentPath, userDirPath, logsPath, historyDirPath;
    private final String applicationDirectoryName = "FileSafe";
    private final Blowfish bf;
...
//        System.out.println(dir);
    ...
    /**
     * Read file as byte stream
     * @param absolutFilepath
     * @return 
     */
    public byte[] readFileAsByteStream(String absolutFilepath) {
        try {
            byte[] b;
            try (RandomAccessFile f = new RandomAccessFile(absolutFilepath, "r")) {
...
//		GenericExtFilter filter = new GenericExtFilter(ext);
    ...
    public void deleteAFile(String dirPath, String fileName) {
        try {
