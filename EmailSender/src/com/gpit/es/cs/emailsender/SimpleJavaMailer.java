...
public class SimpleJavaMailer {
    ...
    */
    ...
    public boolean send () throws Exception {
        ...
        try{
            Logger.getLogger(this.getClass().getName().toString()).log(Level.INFO," Email sending Started "+new Date(System.currentTimeMillis()));
            ...
            try{
                ...
                Logger.getLogger(this.getClass().getName().toString()).log(Level.INFO," Output file does not exist to delete.");
                ex.printStackTrace();
            }
            status = true;
        }
        ...
        Logger.getLogger(this.getClass().getName().toString()).log(Level.INFO," Email sending completed");
        return status;
    }
}
